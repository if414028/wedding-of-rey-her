...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: image, width: 1200, height: 627, alt: "The Wedding of Reynaldo & Herlina" }],
      type: "website",
    },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="id">
      <head>
        <link rel="preload" as="image" href="/images/cover-reynaldo-herlina.webp" fetchPriority="high" />
      </head>
      <body>{children}</body>
    </html>
  );
