...
**Project:** Reynaldo & Herlina Wedding
**Generated:** 2026-07-22 13:30:28
**Category:** Wedding/Event Planning

## Project Override — `design.md`

The repository root `design.md` is the source of truth for component geometry,
spacing, interaction, depth, and accessibility. Its retail-green colors are
adapted—not copied literally—to the wedding identity: warm cream and ceramic
surfaces, espresso feature bands, dusty rose romance accents, sage semantic
success states, and gold reserved for ceremonial focus. The existing watercolor
floral artwork and editorial serif typography remain the visual signature.
